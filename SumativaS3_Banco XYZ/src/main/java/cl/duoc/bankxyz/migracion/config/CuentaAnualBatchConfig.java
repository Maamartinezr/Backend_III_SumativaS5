...
public class CuentaAnualBatchConfig {
    ...
    @Bean
    public BatchStepListener cuentaAnualStepListener(@Value("${bankxyz.batch.thread-count:3}") int threadCount,
    ...
    public Step cuentaAnualStep(JobRepository jobRepository,
                                 ...
                                 @Qualifier("cuentaAnualStepListener") BatchStepListener cuentaAnualStepListener,
