...
public class InteresBatchConfig {
    ...
    @Bean
    public BatchStepListener interesStepListener(@Value("${bankxyz.batch.thread-count:3}") int threadCount,
    ...
    public Step interesStep(JobRepository jobRepository,
                             ...
                             @Qualifier("interesStepListener") BatchStepListener interesStepListener,
