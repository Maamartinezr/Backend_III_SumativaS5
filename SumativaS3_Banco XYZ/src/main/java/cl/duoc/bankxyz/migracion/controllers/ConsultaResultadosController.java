 ...
 * dejo en la base de datos MySQL, luego de dispararlos con los controllers de
 * "/procesar".
 */
@RestController
...
public class ConsultaResultadosController {
    ...
    @GetMapping("/evidencia/jobs")
    public List<Map<String, Object>> evidenciaJobs() {
        return consultaResultadosService.evidenciaJobs();
    }

    @GetMapping("/evidencia/steps")
    public List<Map<String, Object>> evidenciaSteps() {
        return consultaResultadosService.evidenciaSteps();
    }

    @GetMapping("/evidencia/resultados-oficiales")
    public List<Map<String, Object>> evidenciaResultadosOficiales() {
        return consultaResultadosService.evidenciaResultadosOficiales();
    }
}
